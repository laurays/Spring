package sist.co.model;
	...
	*/
	...
	public class SistBBSDTO {
		...
		public SistBBSDTO(int seq, String id, int ref, int step, 
				int depth, String title, String content, 
		...
		public String toString() {		
			return "SistBBSDTO[seq=" + seq + ", id=" + id + ", ref=" + ref
					+ ", step=" + step + ", depth=" + depth + 
					", title=" + title + ", content=" + content 
					+ ", wdate=" + wdate + ", parent=" + parent 
